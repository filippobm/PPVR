    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        EleicaoId = c.Short(nullable: false),
                        Nome = c.String(nullable: false, maxLength: 100),
                        NomeUrna = c.String(nullable: false, maxLength: 60),
                        CargoEletivo = c.Byte(nullable: false),
                        NumeroEleitoral = c.Int(nullable: false),
                        SiglaUnidadeFederacao = c.String(nullable: false, maxLength: 2, fixedLength: true, unicode: false),
                        SiglaUnidadeEleitoral = c.String(nullable: false, maxLength: 60),
                        DescricaoUnidadeEleitoral = c.String(nullable: false, maxLength: 255),
                        Enabled = c.Boolean(nullable: false),
                        CreatedAt = c.DateTime(nullable: false),
                        UpdatedAt = c.DateTime(),
                    })
                .PrimaryKey(t => t.CandidatoId)
                .ForeignKey("dbo.Eleicoes", t => t.EleicaoId)
                .ForeignKey("dbo.Partidos", t => t.PartidoId)
                .Index(t => t.PartidoId)
                .Index(t => t.EleicaoId)
                .Index(t => t.Nome, name: "IX_CANDIDATO_NOME")
                .Index(t => t.NomeUrna, name: "IX_CANDIDATO_NOME_URNA")
                .Index(t => new { t.SiglaUnidadeFederacao, t.SiglaUnidadeEleitoral, t.NumeroEleitoral }, name: "IX_CANDIDATO_NUMERO_ELEITORAL_SIGLA_UE_SIGLA_UF");
            ...
            CreateTable(
                ...
                .Index(t => new { t.Ano, t.Turno, t.Descricao }, unique: true, name: "IX_ELEICAO_ANO_TURNO_DESCRICAO");
